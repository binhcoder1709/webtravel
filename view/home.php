        ...
        <form action="">
          <div class="destinations">
            ...
            <select name="destination" id="">
              ...
              <option value="">Sea island</option>
              <option value="">North Central Tourism</option>
            </select>
          </div>
          <div class="adults">
            <h3>Adults</h3>
      ...
      <div class="welcome">
        <div class="welcome-text">
          <div class="welcome-text-1">
            <h3>welcome Tour Travels</h3>
            <h1>Travel's The World One Place At A Time</h1>
            <p>We would love to help you realize your travel dreams,
               to start a new. Take the first steps towards making your dream a reality.</p>
          </div>
          <div class="welcome-text-2">
            <div class="welcome-text-2-content-1">
              <h3>Best Travel Agents</h3>
              <p>We've 30 years experience of organising the worldwide travel</p>
            </div>
            <div class="welcome-text-2-content-2">
          ...
          <div class="welcome-text-3">
            ...
            <span>We Have 25+ Years Of Experience For Give You Better Tour & Travels Package</span>
          </div>
        </div>
